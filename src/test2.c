...
static void usage(void)
{
	...
	fprintf(stderr, "    -i raw input audio	: ALSA input PCM device\n");
	fprintf(stderr, "    -o midiout		: ALSA output MIDI sequencer\n");
	fprintf(stderr, "    -O filename	: raw data transcript file\n");
	fprintf(stderr, "    -c channels	: number of input channels\n");
	fprintf(stderr, "    -r samplerate	: number of samples acquired per second\n");
	fprintf(stderr, "    -f frames 		: number of samples processed in a single window\n");
...
int main (int argc, char *argv[])
{
  ...
  char *audio_in = NULL, *midi_out = NULL, *portname = NULL;
